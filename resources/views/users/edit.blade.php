                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="bio" name="bio" rows="3" 
                                    class="shadow-sm focus:ring-neutral-500 focus:border-neutral-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                                    {{ $user->bio }}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                ...
                                <input class="w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl ml-5" name="image" id="file_input" type="file">
                            </div>
                            @error('image')
                            <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div>
                            <div class="flex items-start">
                                ...
                                <div class="ltr:ml-3 rtl:mr-3 text-sm">
                                    <label for="private_account" class="font-medium text-gray-700 ml-2">{{ __('Private Account') }}</label>
                                </div>
                            </div>
                        </div>
