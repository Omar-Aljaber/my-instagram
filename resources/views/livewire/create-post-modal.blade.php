<div class="h-[50rem] flex flex-col justify-center">
    ...
    @if ($image)
        <img class="h-[47rem] w-auto object-cover" src="{{ $image->temporaryUrl() }}">
    @endif
    @if (!$image)
        <div class="grow flex flex-col h-full items-center justify-center">
            <div class="mb-4">
                <svg aria-label="Icon to represent media such as images or videos" class="_ab6-" color="#262626" fill="#262626"
